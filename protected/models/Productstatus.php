 ...
 *
 * The followings are the available columns in table 'productstatus':
...
class Productstatus extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('productStatusID, name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'products' => array(self::HAS_MANY, 'Product', 'productStatusID'),
		);
	}
